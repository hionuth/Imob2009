		 ...
		 _init:function(){
		    ...
		    $("#droppable").droppable({
		     ...
		     textelements:function(element){
		    	 	$(element).css({margin:2,height:20});
		            $(element).bind({
		              focusin: function() {
		     ...
		     checkboxes:function(element){
		        ...
		        parent.wrap("<span class='ui-state-default ui-corner-all' style='display:inline-block;width:16px;height:16px;margin-right:5px;margin-top:2px;margin-left:2px;'/>");
		        parent.parent().addClass('hover');
		        if ($(element).attr("checked")) {parent.toggleClass("ui-icon ui-icon-check");}
		     ...
		     radio:function(element){
		      ...
		      selector:function(element){
		        ...
		        parent.css({"display":"inline-block",width:180,height:20}).addClass("ui-state-default ui-corner-all");
		        $(element).addClass("ui-helper-hidden");
		        ...
		        parent.after("<ul class=' ui-helper-reset ui-widget-content ui-helper-hidden' style='position:absolute;z-index:500;width:140px;' ></ul>");
